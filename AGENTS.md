...
- **测试**：`flutter test --exclude-tags live,external --no-pub`（当前基线 **2288 用例全绿**，2026-09-03 A.12.36 核）
- **变异验证脚本**：`yuesheng-flutter/tool/_c68_mutation.py`（ADR-C68 护栏用；改源码做验证的脚本范式，见 V4.10）
