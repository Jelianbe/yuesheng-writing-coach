...
> **版本**: v5.0
> **创建**: 2026-06-23
> **作者**: AI 架构师（Sprint 12 Build 阶段）
> **状态**: ACTIVE（取代 v3.9.0 + 5 SKILL 拆分）
> **来源**: 5 SKILL-*.md 合并（v4 拆分产物逆转）
> **Skill 顺序**: IDENTITY → TEACHING → VALIDATION → FEEDBACK → SCENARIO
> **回退**: `git checkout v3.9.0 -- resources/prompts/yuesheng-prompt-v3.md`
> **依据**: 设计 005 §三 Sprint 12 / R-025 Prompt 治理 / R-018 变更溯源

---

## 1. IDENTITY（来自 SKILL-IDENTITY.md）

> **原标题**: Skill: 身份与底线
> **原 Source**: yuesheng-prompt-v3.md §一 + §2.6
...
## 2. TEACHING（来自 SKILL-TEACHING.md）

> **原标题**: Skill: 教学策略
> **原 Source**: yuesheng-prompt-v3.md §三/四/五/六/九/十
...
## 3. VALIDATION（来自 SKILL-VALIDATION.md）

> **原标题**: Skill: 输出验证
> **原 Source**: yuesheng-prompt-v3.md §八
...
## 4. FEEDBACK（来自 SKILL-FEEDBACK.md）

> **原标题**: Skill: 认知反馈
> **原 Source**: yuesheng-prompt-v3.md §七
...
## 5. SCENARIO（来自 SKILL-SCENARIO.md）

> **原标题**: Skill: 场景规则扩展
> **原 Source**: yuesheng-prompt-v3.md §十一
