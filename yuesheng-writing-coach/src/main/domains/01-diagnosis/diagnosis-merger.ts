...
import type { TeachingStateService } from '../03-teaching/teaching-state.service';
import type { DiagnosisEntry } from '../../../shared/types/index';
import { mergeSyndromesIntoState } from './diagnosis-merger-utils';
import { enterReflectionIfTriggered } from '../03-teaching/state/teaching-state-machine';
