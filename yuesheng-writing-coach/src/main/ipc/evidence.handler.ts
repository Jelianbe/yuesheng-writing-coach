...
export function registerEvidenceHandlers(): void {
  ...
  ipcMain.handle(IPC_CHANNELS.EVIDENCE_GET_BY_DISEASE, (_event, args) => {
    try {
  ...
  ipcMain.handle(IPC_CHANNELS.EVIDENCE_GET_BY_ABILITY, (_event, args) => {
    try {
  ...
  ipcMain.handle(IPC_CHANNELS.EVIDENCE_GET_CHAIN, (_event, args) => {
    try {
  ...
  ipcMain.handle(IPC_CHANNELS.EVIDENCE_CREATE, (_event, args) => {
    try {
  ...
  ipcMain.handle(IPC_CHANNELS.EVIDENCE_GET_BY_SYNDROME, (_event, args) => {
    try {
