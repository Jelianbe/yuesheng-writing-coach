...
import type { RouterConfigs, UserTypeMapConfig } from './teaching-strategy-router.types';
import { ENTRY_TO_STRATEGY, USER_TYPE_MODE_TO_TEACHING_MODE, LAYER2_THEORY_RULE_IDS } from './teaching-strategy-router.constants';
import { matchesCondition, getDominantSyndromeType } from './teaching-strategy-router.conditions';
