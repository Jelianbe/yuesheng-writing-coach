...
export const TechniqueLibraryPage: React.FC<{ params?: Record<string, string> }> = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      <header style={{
        ...
        <h1 style={{ fontSize: 16, fontWeight: 600, color: 'var(--text-primary)', margin: 0 }}>技法库</h1>
      </header>
