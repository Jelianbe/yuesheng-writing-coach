...
export function App(): React.ReactElement {
  ...
  const { errorCards, recommendations, readingDecision, activeTraining, history, submissionResult, evaluationResult, isLoading, error, bridgeRecommendation, startTraining, startReading, submitStep, skipTraining, updateDraft, dismissBridge, backToChat, sendToEditor } = useTrainingStore();
