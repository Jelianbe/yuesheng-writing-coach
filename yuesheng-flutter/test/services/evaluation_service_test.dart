...
void main() {
  ...
  group('A11 取数方向断言：最新/最旧不靠 slice 巧合', () {
    DiagnosisRow diag(String id, String severity) => DiagnosisRow(
      id: id,
      sessionId: 's',
      messageId: 'm$id',
