...
///
/// 架构：
///   L1 常驻（实测 29,032 字符）— 核心规则 + 态度档位，所有场景必加载
...
/// L1 层：所有场景均加载的核心 skill（实测 29,032 字符总计 =
/// 九件套 27,843 + attitude-yuesheng 1,189；口径见文件头，2026-09-14）
const List<String> l1SkillIds = [
  ...
  'teaching-strategy', // 实测 12,209 字符
  ...
  // + attitude-yuesheng (实测 1,189 字符) → 总计 29,032（口径见文件头，2026-09-14）
];
